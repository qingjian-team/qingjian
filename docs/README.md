...
<<<<<<< HEAD
| [plan/linux_fcitx5_stage1_revision_plan.md](plan/linux_fcitx5_stage1_revision_plan.md) | Linux Fcitx5 第一阶段范围、实施与验收方案 |
| [notes/linux-fcitx5.md](notes/linux-fcitx5.md) | Linux 默认面板构建、协议、安装与排错 |
| [user/getting-started/linux.md](user/getting-started/linux.md) | Linux 用户安装、手动运行和卸载 |
=======
