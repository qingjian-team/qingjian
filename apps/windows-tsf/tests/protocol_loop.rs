//! DLL 引擎层的端到端协议测试：把 [`EngineClient`] 接到真正的 Server（`qingjian-windows` 的
//! [`Router`] + [`serve`](qingjian_windows::ipc::serve)），两端各在一条 socketpair 上，验证
...
use qingjian_windows::{Router, assembly, ipc};
