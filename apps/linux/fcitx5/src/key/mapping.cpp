...
nlohmann::json mapKey(const fcitx::Key &key) {
    ...
    case FcitxKey_End: code = 0x23; break;
    case FcitxKey_Home: code = 0x24; break;
    case FcitxKey_Left: code = 0x25; break;
    case FcitxKey_Up: code = 0x26; break;
    case FcitxKey_Right: code = 0x27; break;
    case FcitxKey_Down: code = 0x28; break;
    case FcitxKey_Delete: case FcitxKey_KP_Delete: code = 0x2e; break;
    default:
        if (key.sym() >= FcitxKey_KP_0 && key.sym() <= FcitxKey_KP_9) code = 0x30 + key.sym() - FcitxKey_KP_0;
        break;
    }
